...
%changelog
* Wed Sep 23 2026 Mika Heiskanen <mika.heiskanen@fmi.fi> - 26.9.3-2.fmi
...
* Thu Oct 23 2025 Andris Pavēnis <andris.pavenis@fmi.fi> 25.10.23-1.fmi
- Fix getting pointer to grid engine
...
- Added PostgreSQL option for content storage
...
- Repackage due smartmlibrary-grid-files changes
